...
/****** Bemf Observer ****/
#define M1_BEMF_SAMPLING_TIME              LL_ADC_SAMPLING_CYCLE(7)
...
#define SPEED_THRESHOLD_DEMAG              ((uint32_t)25000) /*!< Speed threshold above which the  RUN_DEMAGN_DELAY_MIN is applied */
...
#define SW_DEADTIME_NS                     200 /*!< Dead-time to be inserted by FW, only if low side signals are enabled */

/* Speed control loop */
#define SPEED_LOOP_FREQUENCY_HZ            (uint16_t)1000 /*!<Execution rate of speed regulation loop (Hz) */
#define PID_SPEED_KP_DEFAULT               310/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM           7500
...
#define PHASE2_FINAL_SPEED_UNIT            (7500*SPEED_UNIT/U_RPM)
#define PHASE2_VOLTAGE_RMS                 6.27

/* Phase 3 */
#define PHASE3_DURATION                    500 /* milliseconds */
#define PHASE3_FINAL_SPEED_UNIT            (7500*SPEED_UNIT/U_RPM)
#define PHASE3_VOLTAGE_RMS                 6.27
...
#define OBS_MINIMUM_SPEED_RPM              5400
